package com.example.denijel.joystick;
...
public class BTList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PairedDevices=new ArrayAdapter<String>(BTList.this ,R.layout.forlist);
    ...
    protected void onPause()
    {
        if(ba.isDiscovering()==true)
            ba.cancelDiscovery();
        (BTList.this).unregisterReceiver(mReceiver);
        super.onPause();
